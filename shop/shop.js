...
fltr.addEventListener('keyup', () => {
  ...
  if (myArr.length == 0) {
    // console.log("search")
    grid.innerHTML = `Oops,No products found for this filtering, try different combinations!`
...
function addElement(appendIn, value) {
  ...
  let { id, title, price, description, category, image, rating, color } = value;
    //  console.log(color)
  myDiv.innerHTML =
